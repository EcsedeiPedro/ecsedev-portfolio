        ...
        <div className="flex flex-col sm:flex-row sm:items-center">
          <div className="w-1/2">
            <div className="text-white">
              <h1 className="text-4xl flex flex-col tracking-widest text-left w-max">
                hello, i am
                <span className="text-6xl tracking-widest text-lightRed leading-none font-medium self-start w-max text-left -ml-[1px]">
                  Pedro
                  <br />
                  Ecsedei
                </span>
              ...
              <p className="text-2xl tracking-widest text-orange text-left w-max ml-[2px]">
                Fullstack Developer
              </p>
            </div>
          </div>
